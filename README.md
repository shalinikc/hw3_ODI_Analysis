...
For the remote repository, make a github repository named hw3_ODI_Analysis, then do;

```bash
git remote add origin git@github.com:shalinikc/hw3_ODI_Analysis.git
git branch -M main
...
Here's the folder structure that gets created by `cookiecutter-datascience-simple`:
	...
	├── hw3_ODI_Analysis	<- Your notebooks and scripts will live in the main project folder
